...
//애정운
  ...
  var affection_luck = [
    ...
    "이성문제로 나의 사회활동까지 방해받지 않도록 주의해야 하네..",
    "애정운이 길하지 못하니 이성을 만나기 보다는 나의 학업에 더 충실한게 좋을 듯 하네..",
    "친해지고 싶다면 그대가 먼저 대화를 걸어보게.<br> 공통관심사를 찾는게 먼저이니.",
    "이성친구에게는 유치한 말장난이라도 상대방은 진지할 수 있으니 농담을 가려야 한다네.",
    "연인관계가 좋아지는 하루가 될 것이네.<br> 가까운 곳으로 나들이가는건 어떤가."
  ];
