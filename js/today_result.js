...
//학업운
  ...
  "아주 천천히 느긋하게 생각해도 늦지 않을테니 시간을 조금 더 가져보길 바라네.",
  "원하는 답변이 있다면 질문을 잘 해야 하지. 더 말을 많이 이끌어내길.",
  "질투는 모두 자격지심에서 생긴 감정이네. 남탓을 하지 말고 자신감을 가지는게 중요하네.",
  "익숙한 것에서 벗어나 새로운 것을 만들어보아라. 변화가 필요한 하루이니.",
  "상대방의 부탁을 들어주기 힘들다면 고민하지 말고 단호하게 거절하는 것이 좋다네."
];
