window.onload = function () {
  ...
  var riches_luck = [
    ...
    "얻는 것이 많은 하루네.<br> 물이 들어왔을 때 열심히 노를 저어보길 바라네.",
    "빌리는 것이 아니라 주는 것일 수도 있네.<br> 그래도 괜찮다면 빌려주도록 하게.",
    "돈 뿐만이 아니라 물건이 오고가는 거래도 문서나 문자로 증거를 남겨보게.",
    "오늘을 열심히 살았다면 그에 대한 보답이 있을 것이니, 매일매일 최선을 다하길.",
    "승산이 보이지 않는다면 피하는 것이 정답.<br> 억지로 하지 않아도 괜찮다네."
  ];
